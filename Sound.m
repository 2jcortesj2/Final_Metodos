classdef Sound < handle
    ...
    methods (Access = public)
        function recordAudio(obj, folderPath)
            ...
            disp("Archivo guardado correctamente.");
        end
        ...
        function alignedSignal = alignDuration(obj, signal, targetDuration)
            ...
            elseif signalDuration > targetDuration
                % Acortar el signal para igualar la duración objetivo
                alignedSignal = signal(1:targetDuration);
            else
